...
#    beats=beats[:20].reshape(-1,1)
    ...
    all_cc=np.concatenate((all_cc,mfcc_cc),axis=1)
...
mlp = MLPClassifier(hidden_layer_sizes=(45,20))
...
mlp2 = MLPClassifier(hidden_layer_sizes=(45,20))
...
X_VALID2=scaler2.transform(X_VALID)
# perform prediction on validation data
y_valid = mlp.predict(X_VALID2)
...
output_file='mfcc_osc_mfcc_all_result_SVM.csv'

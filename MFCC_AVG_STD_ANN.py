...
for name_label in file_list_label:
    ...
    mfcc_cc=np.concatenate((mfcc_avg,mfcc_std),axis=0)
...
for name in validation_file_list:
    ...
    # take std_dev of MFCC co-efficients across all frames
    mfcc_std=np.std(mfcc,axis=1)
...
output_file='MLP_MFCC_AVG_STD_result.csv'
